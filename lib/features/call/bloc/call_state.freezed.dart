...
/// @nodoc
mixin _$CallStateOpenPage {

 User get otherUser;
/// Create a copy of CallStateOpenPage
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$CallStateOpenPageCopyWith<CallStateOpenPage> get copyWith => _$CallStateOpenPageCopyWithImpl<CallStateOpenPage>(this as CallStateOpenPage, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CallStateOpenPage&&(identical(other.otherUser, otherUser) || other.otherUser == otherUser));
}


@override
int get hashCode => Object.hash(runtimeType,otherUser);

@override
String toString() {
  return 'CallStateOpenPage(otherUser: $otherUser)';
}
...
/// @nodoc
abstract mixin class $CallStateOpenPageCopyWith<$Res>  {
  factory $CallStateOpenPageCopyWith(CallStateOpenPage value, $Res Function(CallStateOpenPage) _then) = _$CallStateOpenPageCopyWithImpl;
@useResult
$Res call({
 User otherUser
});
...
/// @nodoc
class _$CallStateOpenPageCopyWithImpl<$Res>
    implements $CallStateOpenPageCopyWith<$Res> {
  _$CallStateOpenPageCopyWithImpl(this._self, this._then);

  final CallStateOpenPage _self;
  final $Res Function(CallStateOpenPage) _then;

/// Create a copy of CallStateOpenPage
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? otherUser = null,}) {
  return _then(_self.copyWith(
...
/// Adds pattern-matching-related methods to [CallStateOpenPage].
extension CallStateOpenPagePatterns on CallStateOpenPage {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _CallStateOpenPage value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _CallStateOpenPage() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _CallStateOpenPage value)  $default,){
final _that = this;
switch (_that) {
case _CallStateOpenPage():
return $default(_that);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _CallStateOpenPage value)?  $default,){
final _that = this;
switch (_that) {
case _CallStateOpenPage() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( User otherUser)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CallStateOpenPage() when $default != null:
return $default(_that.otherUser);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( User otherUser)  $default,) {final _that = this;
switch (_that) {
case _CallStateOpenPage():
return $default(_that.otherUser);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( User otherUser)?  $default,) {final _that = this;
switch (_that) {
case _CallStateOpenPage() when $default != null:
return $default(_that.otherUser);case _:
  return null;
...
class _CallStateOpenPage implements CallStateOpenPage {
  const _CallStateOpenPage({required this.otherUser});
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$CallStateOpenPageCopyWith<_CallStateOpenPage> get copyWith => __$CallStateOpenPageCopyWithImpl<_CallStateOpenPage>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CallStateOpenPage&&(identical(other.otherUser, otherUser) || other.otherUser == otherUser));
}
...
/// @nodoc
abstract mixin class _$CallStateOpenPageCopyWith<$Res> implements $CallStateOpenPageCopyWith<$Res> {
  factory _$CallStateOpenPageCopyWith(_CallStateOpenPage value, $Res Function(_CallStateOpenPage) _then) = __$CallStateOpenPageCopyWithImpl;
@override @useResult
$Res call({
 User otherUser
});
...
/// @nodoc
class __$CallStateOpenPageCopyWithImpl<$Res>
    implements _$CallStateOpenPageCopyWith<$Res> {
  __$CallStateOpenPageCopyWithImpl(this._self, this._then);

  final _CallStateOpenPage _self;
  final $Res Function(_CallStateOpenPage) _then;

/// Create a copy of CallStateOpenPage
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? otherUser = null,}) {
  return _then(_CallStateOpenPage(
otherUser: null == otherUser ? _self.otherUser : otherUser // ignore: cast_nullable_to_non_nullable
as User,
  ));
}
